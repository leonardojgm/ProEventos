...
namespace ProEventos.Application
{
    public class RedeSocialService : IRedeSocialService
    {
        ...
        public async Task<RedeSocialDto[]> SaveByEvento(int eventoId, RedeSocialDto[] models)
        {
            try
            {
                var redeSociais = await _redeSocialPersist.GetAllEventoIdAsync(eventoId);
                ...
                var redeSocialRetorno = await _redeSocialPersist.GetAllEventoIdAsync(eventoId);
        ...
        public async Task<RedeSocialDto[]> SaveByPalestrante(int palestranteId, RedeSocialDto[] models)
        {
            try
            {
                var redeSociais = await _redeSocialPersist.GetAllPalestranteIdAsync(palestranteId);
                ...
                var redeSocialRetorno = await _redeSocialPersist.GetAllPalestranteIdAsync(palestranteId);
